...
type storageBlock struct {
	counterType  string  // 统计类型，是做uv统计还是pv统计
...
func main() {
	...
	// 获取参数
	logFilePath := flag.String("logFilePath", "D://MyApplication//goland//goproject//logAnalysis//logs//dig.log", "log file path")
	routineNum := flag.Int("routineNum", 5, "consumer number by goroutine")
	l := flag.String("l", "D://MyApplication//goland//goproject//logAnalysis//logs//tmp//log", "this programe runtime log target file path")
	flag.Parse()
